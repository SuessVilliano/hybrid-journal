            ...
            <div className="flex items-center gap-4 flex-1">
              ...
              <div className="hidden md:flex items-center gap-6 flex-1">
                ...
                <div>
                  ...
                  <div className="text-sm font-medium">{trade.entry_price?.toFixed(5) || 'N/A'}</div>
                </div>

                <div>
                  <div className="text-xs text-slate-500">Exit</div>
                  <div className="text-sm font-medium">{trade.exit_price?.toFixed(5) || 'Open'}</div>
                </div>
                ...
                {trade.strategy && (
                  <div>
                    ...
                    <div className="text-sm font-medium">{trade.strategy}</div>
                  </div>
                )}
              </div>
